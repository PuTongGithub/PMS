...
<%@ page import="java.util.Hashtable" %>
	...
	Vector recruit = (Vector)request.getAttribute("recruit");// 员工列表
...
<div class="main-wrap">
	...
	<div class="content-wrap">
		<header class="top-hd">
			...
			<form action="ReportRecruit.jsp" method="post">			
...
%>
			...
			<div class="page-wrap">
				...
				<table class="table table-bordered  mb-15" id="table2">
					...
					<% 
						if(recruit!=null){
	for(int i = 0; i < recruit.size(); i = i + 1) {
		Hashtable yg = (Hashtable)recruit.get(i);
		out.println("<tr>");
		...
		out.println("<td>" + yg.get("entry_date") + "</td>");
		out.println("<td>" + yg.get("statu") + "</td>");
		out.println("<td>" + yg.get("education") + "</td>");
		out.println("</tr>");
	}
     }
	%>
...
<script src="Blob.js"></script>
	...
	$exportLink.addEventListener('click', function(e){
		...
		if(e.target.nodeName === "A"){
			...
			tableExport('table2', '员工报表', e.target.getAttribute('data-type'));
