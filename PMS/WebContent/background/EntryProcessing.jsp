...
String sql = "insert into employee (name,sex,number,birthday,id_number,department,position,entry_date,work_date,employment_form,personnel_source,statu)"+
                                    " values "+
                                    "('"+name+"',"+
                                    "'"+sex+"',"+
                                    "'"+number+"',"+
...
sql = "insert into people (name,number,phone_number,email,address,marriage,political,education,school,notes,major,graduate_date,folk)"+
		                            " values "+
		                            "('"+name+"',"+
		                            "'"+number+"',"+
		                            "'"+phone_number+"',"+
